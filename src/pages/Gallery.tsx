...
const CATEGORIES = ['All', 'Dishes', 'Ambiance', 'Kitchen'] as const;
  ...
  return (
    <div className="pt-32 pb-20">
      <header className="text-center mb-16 px-6">
        ...
        >
          <span className="text-gold uppercase tracking-[0.4em] text-xs font-bold mb-4 block">Visual Journey</span>
          <h1 className="text-5xl md:text-7xl font-serif font-bold mb-8">The Gallery</h1>
        </motion.div>
      ...
      <section className="mt-32 py-20 text-center px-6 border-t border-white/5">
        <p className="text-white/40 uppercase tracking-[0.4em] text-xs mb-6">Follow our story</p>
        <h2 className="text-3xl font-serif font-bold mb-10">@LumiereGastronomy</h2>
